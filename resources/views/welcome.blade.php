    ...
    <div id="landingHero" class="section-py landing-hero position-relative">
      <div class="container">
        <div class="hero-text-box text-center">
          <h1 class="text-primary hero-title display-4 fw-bold">هل تبحث عن التميز و التفوق</h1>
          <h2 class="hero-sub-title h6 mb-4 pb-1">
            هل تبحث عن النجاح
            <br class="d-none d-lg-block" />
            انت في العنوان الصحيح
          </h2>
          <div class="landing-hero-btn d-inline-block position-relative">
            <span class="hero-btn-item position-absolute d-none d-md-flex text-heading">انضم الينا
              <img src="{{asset('assets/img/front-pages/icons/Join-community-arrow.png')}}" alt="Join community arrow" class="scaleX-n1-rtl" /></span>
            <a href="#landingPricing" class="btn btn-primary">اعرف المزيد</a>
          </div>
        </div>
        <div id="heroDashboardAnimation" class="hero-animation-img">
          <a href="{{url('/app/ecommerce/dashboard')}}" target="_blank">
            <div id="heroAnimationImg" class="position-relative hero-dashboard-img">
              <img src="{{asset('assets/img/front-pages/landing-page/welcomeimg1.png')}}" alt="hero dashboard" class="animation-img" data-app-light-img="front-pages/landing-page/welcomeimg1.png" data-app-dark-img="front-pages/landing-page/welcomeimg1.png" />
              <img src="{{asset('assets/img/front-pages/landing-page/welcomeimg1.png')}}" alt="hero elements" class="position-absolute hero-elements-img animation-img top-0 start-0" data-app-light-img="front-pages/landing-page/welcomeimg1.png" data-app-dark-img="front-pages/landing-page/welcomeimg1.png" />
            </div>
          </a>
        </div>
      </div>
